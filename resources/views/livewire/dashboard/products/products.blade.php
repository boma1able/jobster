...
{{--        <input type="text" wire:model="name" placeholder="Назва товару">--}}
{{--        <input type="text" wire:model="description" placeholder="Опис">--}}
{{--        <input type="number" wire:model="price" placeholder="Ціна">--}}

<tr class="align-middle">
    ...
    <td class="px-6 py-4 text-sm font-medium">
        <div class="flex">
            <a href="{{ route('dashboard.users.edit', $user->id) }}" class="text-indigo-600 hover:text-indigo-900">
            ...
            <button onclick="openDeleteModal({{ $user->id }}, 'users')" class="text-red-600 hover:text-red-900 ml-4">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">

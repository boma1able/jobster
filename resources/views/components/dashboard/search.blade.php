...
<form method="GET" action="{{ $route }}" class="flex flex-wrap">
    ...
    <div class="relative flex items-center rounded-md bg-white px-3 ">
        <x-form.input type="text" name="search" id="search" :value="request('search')" class="font-light pr-10" placeholder="Search..." required/>

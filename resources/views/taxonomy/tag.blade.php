<x-layout>
    ...
    <x-breadcrumbs :tag="$tag"/>

    <div class="bg-white py-6 sm:py-20">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl lg:mx-0">
                <h2 class="text-4xl font-semibold tracking-tight text-pretty text-gray-900 sm:text-5xl">{{ $tag->name }}</h2>
                <p class="mt-2 text-lg/8 text-gray-600">{{ $tag->description }}</p>
            </div>
